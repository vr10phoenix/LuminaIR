...
def apply_cloud_mask(rgb_stack, ir_aligned, master_kwargs):
    ...
    # Landsat 8/9 QA_PIXEL Bit 3 is Cloud, Bit 4 is Cloud Shadow. 
    # For a robust mask, we flag any pixel that is a cloud, shadow, or dilated cloud.
    # Note: QA values can be complex, but standard clear land/water is typically 21824 or 21888.
    # We will create a boolean mask where True = BAD pixel (cloud/shadow)
    # Bitwise operations: 1<<3 is cloud, 1<<4 is shadow
